...
/**
 * Representation of the 'UpdateFolderDocumentLinkApi'.
 * This API is part of the 'UpdateFolder_Document_LinkApi' service.
 */
export const UpdateFolderDocumentLinkApi = {
  /**
